...
- command:
  ...
  +model.pretrained_models={bert-base-cased-re-tacred: ${local_pretrained_model_dir}/bert-base-cased-re-tacred-20230919-hf,bert-base-cased-ner-ontonotes: ${local_pretrained_model_dir}/bert-base-cased-ner-ontonotes} \
  +model.freeze_models=[bert-base-cased-re-tacred,bert-base-cased-ner-ontonotes] \
  +model.aggregate=attention \
...
- command:
  ...
  python src/train.py \
  experiment=tacred_multimodel_base \
  +model.pretrained_models={bert-base-cased-re-tacred: ${local_pretrained_model_dir}/bert-base-cased-re-tacred-20230919-hf,bert-base-cased-qa-squad2: ${local_pretrained_model_dir}/bert-base-cased-qa-squad2} \
...
- command:
  ...
  python src/train.py \
  experiment=tacred_multimodel_base \
  +model.pretrained_models={bert-base-cased-re-tacred: ${local_pretrained_model_dir}/bert-base-cased-re-tacred-20230919-hf,bert-base-cased-coref-hoi: ${local_pretrained_model_dir}/bert-base-cased-coref-hoi} \
...
- command:
  ...
  python src/train.py \
  experiment=tacred_multimodel_base \
  +model.pretrained_models={bert-base-cased-re-tacred: ${local_pretrained_model_dir}/bert-base-cased-re-tacred-20230919-hf,bert-base-cased-mrpc: bert-base-cased-finetuned-mrpc} \
