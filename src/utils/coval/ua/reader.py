...
def get_coref_infos(
    ...
    for doc in key_docs:
        ...
        key_clusters, key_bridging_pairs = get_doc_markables(
            doc, key_docs[doc], use_MIN, keep_bridging, markable_column=markable_column
        )
        sys_clusters, sys_bridging_pairs = get_doc_markables(
            doc, sys_docs[doc], False, keep_bridging, markable_column=markable_column
        )
